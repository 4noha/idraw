...
public class User extends DbInstanceDao<User>{
	...
	// 検索関数を定義
	public static User findBy(String column_name, Object value) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, NoSuchFieldException, SecurityException{
		adapterStandby();
		return dbStaticAdapter.findBy(column_name, value);
	}
	public static ArrayList<User> findPartial(String column_name, String value) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, NoSuchFieldException, SecurityException{
		adapterStandby();
